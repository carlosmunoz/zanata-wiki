 ...
 * After toggle from disable to enable: 
 ** Review UIs (The UI that reviewer role can access) should be shown.
 * After toggle from enable to disable:
 ** Review UIs should be hidden. (i.e. reviewer role can nolonger approve or reject)
