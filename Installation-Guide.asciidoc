...
=== Virus scanner
Zanata is tested with clamav's virus scanner (clamd/clamdscan)
----
...
You should probably also set up freshclam to run at least once per day, to keep virus definitions up to date.
